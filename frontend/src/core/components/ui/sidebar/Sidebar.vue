...
<template>
	...
	>
		<SheetContent
			...
			data-mobile="true"
			:side="side"
			class="[&>button]:hidden bg-sidebar p-0 w-(--sidebar-width) text-sidebar-foreground"
			:style="{
	...
	>
		...
		>
			<div
				data-sidebar="sidebar"
				class="flex flex-col bg-sidebar group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:rounded-lg w-full h-full"
			>
				<slot />
			</div>
		</div>
