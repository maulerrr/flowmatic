...
| Classification / ML story | Principal model **XGBoost**; compares RF, SVM, LR, NN; abstract cites **RF 96.62%** | **Separate research track**: Q1 checkpoints (TranAD, PatchTST, transformers, graphs, linear baselines); **tabular upload pipeline** does not embed XGBoost training in Nest |
