...
\textbf{RQ4 (routing).} Auto routing achieves 100\% scenario-aligned policy conformance on 140 simulator events whose oracles are co-designed with the documented routing policy. This verifies implementation consistency for the prototype rather than independent expert-labelled routing accuracy.
